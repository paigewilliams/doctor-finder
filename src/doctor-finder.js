export class DoctorFinder {
  findDoctorByName(firstName, lastName) {
    return new Promise(function(resolve, reject) {
      ...
      let url = `https://api.betterdoctor.com/2016-03-01/doctors?first_name=${firstName}&last_name=${lastName}&location=or-portland&skip=0&limit=10&user_key=${process.env.exports.apiKey}`;
